#include<iostream>
#include <queue>
using namespace std;//Class usado como se fosse struct, nao sei pra que serve mas e necessario ser class para fazer a sobrecarga na fila.
class dragao{
    public:
...
int main(){
    ...
    unsigned long long tempo = 0; // fila<nome da classe,o que eu vou colocar na fila, nome da sobrecarga com a forma de ordenacao.
